...
END
    ...
    static function get_notes() {
       ...
       //  https://github.com/bisq-network/bisq/core/src/main/java/bisq/core/payment/payload/PaymentMethod.java
       $payment_methods = [ 
                            "OK_PAY",
                            "PERFECT_MONEY",
                            "SEPA",
        ...
        return ['payment_method in response will be one of: ' . implode( ', ', $payment_methods ),
                'payment_method values are defined in this file: https://github.com/bisq-network/bisq/core/src/main/java/bisq/core/payment/payload/PaymentMethod.java',
